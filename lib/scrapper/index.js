...
var isAccessTokenPage = function(url) {
    var tokenPageExp = /http:\/\/api.vkontakte.ru\/blank.html#access_token/;
...
var authUrl = 'http://api.vkontakte.ru/oauth/authorize?client_id=' + clientId + '&scope=' + scope + '&redirect_uri=http://api.vkontakte.ru/blank.html&response_type=token';
